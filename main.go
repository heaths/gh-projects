...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "projects",
		Short: "Manage organization and repository projects",
		Long: heredoc.Doc(`
		Create, edit, and close organization and repository projects. You can also
	...
	rootCmd.PersistentFlags().BoolVarP(&opts.Org, "org", "O", false, "Managed projects using the repository owner.")
